...
const tiers = [
  {
    name: "Starter",
    description: "For small teams that need searchable media data and basic directory access.",
    price: "₦75,000",
    features: [
      "Searchable media inventory",
      "Media-house directory",
  ...
  {
    name: "Professional",
    description: "For agencies and brands that need planning workflows, exports, and verification.",
    price: "₦250,000",
    features: [
      "Multi-channel campaign planning",
      "Audience and location filters",
      "RFP workflow & budget allocation",
      "Proposal comparison",
